...
data_frame = pd.DataFrame(columns=["Alphabet", "Size", "Width", "Height", "Price"])
...
for idx, html in enumerate(html_list, start=1):
    ...
    for size in sizes:
        ...
        price_element = size.find('strong', class_='price_font')
        if price_element:
        ...
        data_frame.loc[len(data_frame)] = {"Alphabet": alphabet_name, "Size": size_name, "Width": length, "Height": height, "Price": price}

        # Print the formatted output
        formatted_output = f"{size_name} : Width {length}, Height {height}, Price {price}"
        print(formatted_output)

    print()

# Write the DataFrame to an Excel file
data_frame.to_excel("neon_champ_aerolite_sizes_data.xlsx", index=False)

# # Create an empty DataFrame
# data_frame = pd.DataFrame(columns=["Alphabet", "Size", "Width", "Height"])
...
#         # Append the data to the DataFrame
#         data_frame.loc[len(data_frame)] = {"Alphabet": alphabet_name, "Size": size_name, "Width": length, "Height": height}
